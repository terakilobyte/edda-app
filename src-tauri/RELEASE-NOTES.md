...
them, which is how the game credits them. Even so, the game's tally
runs ahead of ours on most missions, and the reason is in the game: a
ship that dies before yours has scanned it earns no bounty and writes
nothing to the journal, but still counts for the mission. So the count
reads "at least N of M", and a mission completes on the game's
