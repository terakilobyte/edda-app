...
const CASES: &[Case] = &[
    ...
    Case { id: "merits", question: "Who am I pledged to in Powerplay, and how many merits do I have?", expect_tools: &["commander_ranks"], forbid_tools: &["powerplay_seen"], must_contain: &["merit"], must_contain_from: Some(("commander_ranks", "/ranks/powerplay/power")), expect_effect: None, max_chars: 400 },
