...
## Cron (systemd timers, ledger-ruled cadence)
...
site and ledger-only pushes skip; a newer push cancels the run in
...
/v1/telemetry client ingest lands once its ledger wire contract is
...
plot-gate-sweep) and the ledger; re-measure before changing a default.
