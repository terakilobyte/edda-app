...
mod tests {
    ...
    fn short_versions_are_stable_distinct_and_dir_shaped() {
        ...
        assert_eq!(a, short_version("routing", 52, "2026-09-04T05:00:00Z"), "deterministic");
        assert_ne!(a, short_version("stars", 52, "2026-09-04T05:00:00Z"), "products diverge at the same sequence");
    ...
    fn version_dir_shapes_cover_legacy_and_hash_but_not_scratch() {
        ...
        assert!(is_version_dir_name("12345678"), "numeric-looking hash is both, still a version");
